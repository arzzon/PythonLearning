 ...
 *  -----------------------------------------------------------------
 *  |   insertion   |   bigO(logN)  |     bigO(-)   |    bigO(-)    |
 *  -----------------------------------------------------------------
 *  | Poll/deletion |   bigO(logN)  |     bigO(-)   |    bigO(-)    | ###Only root node is deleted###
 *  -----------------------------------------------------------------
 *  |   traversal   |    bigO(N)    |     bigO(-)   |    bigO(-)    |
 *  -----------------------------------------------------------------
 *  |   searching   |    bigO(-)    |     bigO(-)   |    bigO(-)    |
 *  -----------------------------------------------------------------
 *  |   heapifyUp   |   bigO(logN)  |     bigO(-)   |    bigO(-)    |
 *  -----------------------------------------------------------------
 *  |  heapifyDown  |   bigO(logN)  |     bigO(-)   |    bigO(-)    |
 *  -----------------------------------------------------------------
